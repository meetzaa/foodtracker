...
class SeeMorePage(BasePage):
    ...
    def create_widgets(self):
        ...
        image_details = [
            ...
            ("frame7/MyMeals.png", 432.0, 298.0, 160.0, 131.0, lambda: self.controller.show_page("LogFoodPage", self.user_key)),
        ...
        font_small = Font(family="Consolas", slant="italic", size=10)
        ...
        self.liters_label = Label(self, text="0.0", font=font_small, bg="#FFFCF1")
