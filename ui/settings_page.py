...
class SettingsPage(BasePage):
    ...
    def create_widgets(self):
        ...
        image_details = [
            ...
            ("Edit_profile.png", 333.0, 161.0, 284.0, 47.0, lambda: self.controller.show_page("EditProfilePage", self.user_key)),
            ("Change_goal.png", 342.0, 223.0, 275.0, 40.0, lambda: self.controller.show_page("SetGoalPage", self.user_key)),
            ("Info_goal.png", 299.0, 274.0, 359.0, 34.0, lambda: self.controller.show_page("GoalInfoPage", self.user_key)),
            ("App_details.png", 338.0, 328.0, 285.0, 43.0, lambda: self.controller.show_page("AppDetailPage", self.user_key)),
            ("SignOut.png", 340.0, 381.0, 277.0, 43.0, lambda: self.controller.show_page("MainPage", self.user_key)),
